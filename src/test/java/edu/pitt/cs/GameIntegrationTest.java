...
public class GameIntegrationTest {
	...
	public void testLoseNoItems() {
		String input = "D" + newline;

		System.setIn(new ByteArrayInputStream(input.getBytes()));

		Game.main(new String[0]);
		assertEquals(loseNoItemsOutput, out.toString());
		System.setIn(stdin);
	}
	...
	public void testLoseWithCream() {
		String input = "L" + newline + "D" + newline;
		ByteArrayInputStream in = new ByteArrayInputStream(input.getBytes());
		System.setIn(in);
		Game.main(new String[0]);
		assertEquals(loseWithCream, out.toString());
		System.setIn(stdin);
	...
	@Test
	public void testWin() {
		String input = "L" + newline + "N" + newline + "N" + newline + "L" + newline + "N" + newline + "N" + newline + "N" + newline + "L" + newline + "D" + newline;
		ByteArrayInputStream in = new ByteArrayInputStream(input.getBytes());
		System.setIn(in);
		Game.main(new String[0]);
		assertEquals(win, out.toString());
		System.setIn(stdin);
	}
}
