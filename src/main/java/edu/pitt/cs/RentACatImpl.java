...
public class RentACatImpl implements RentACat {
	...
	public boolean returnCat(int id) {
		// TODO: Fill in
		Cat curr_cat = getCat(id);
		if(curr_cat == null){
			return false;
		}
		else{
			if(curr_cat.getRented()){
				curr_cat.returnCat();
				System.out.print("Welcome back, " + curr_cat.getName() + "!\n");
				return true;
			}
			System.out.print(curr_cat.getName() + " is already here!\n");
			return false;
		}
	}
	...
	public boolean rentCat(int id) {
		...
		if(curr_cat == null){
			...
			if(curr_cat.getRented() == false){
				curr_cat.rentCat();
				System.out.print(curr_cat.getName() + " has been rented.\n");
				return true;
			}
			System.out.print("Sorry, " + curr_cat.getName() + " is not here!\n");
			return false;
		}
	}
